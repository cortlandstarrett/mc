...
INSERT INTO S_EE VALUES ( ${s_ee.EE_ID}, ${s_ee.Name}, ${s_ee.Descrip}, ${s_ee.Key_Lett}, ${s_ee.Dom_ID}, ${s_ee.Realized_Class_Path}, ${s_ee.Label}, ${s_ee.isRealized} );
.end for
...
INSERT INTO TE_PO VALUES ( ${te_po.ID}, ${te_po.Name}, ${te_po.GeneratedName}, ${te_po.InterfaceName}, ${te_po.PackageName}, ${te_po.message_post}, ${te_po.vector_table}, ${te_po.Provision}, ${te_po.polymorphic}, ${te_po.sibling}, ${te_po.Order}, ${te_po.te_cID}, ${te_po.c_iId}, ${te_po.c_poId}, ${te_po.first_te_mactID} );
.end for
